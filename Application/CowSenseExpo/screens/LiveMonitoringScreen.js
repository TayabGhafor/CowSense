// screens/LiveMonitoringScreen.js
...
const LiveMonitoringScreen = ({ navigation, route }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.subtitle}>Real-time IoT sensor data for environmental and livestock health tracking.</Text>
